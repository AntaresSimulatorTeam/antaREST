...
const PY_DIST = "server"; // python distributable folder
const PY_SRC_FOLDER = "antarest"; // path to the python source
const PY_MODULE = "main.py"; // the name of the main module

const isRunningInBundle = () => {
    console.log(path.join(__dirname, PY_DIST))
  return require("fs").existsSync(path.join(__dirname, PY_DIST));
};
...
const getPythonScriptPath = () => {
  ...
  return path.join(__dirname, PY_DIST);
};
